...
from nova.openstack.common.setup import canonicalize_emails
from nova.openstack.common.setup import parse_mailmap


class SetupTest(unittest.TestCase):

    def setUp(self):
        (fd, self.mailmap) = mkstemp(suffix='.mailmap', prefix='openstack')
